...
export function createGraph(data: any): [Graph, CommunityDetails] {
    ...
    //console.log(communityDetails.communities)

    circlepack.assign(graph, {
        center: 2,
        hierarchyAttributes: [hierarquia],
        scale: 2
    });
